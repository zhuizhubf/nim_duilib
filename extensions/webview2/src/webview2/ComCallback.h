...
public:
    ...
    // 实现 0 参数 Invoke
    STDMETHOD(Invoke)() override { return m_callback(); }
...
public:
    ...
    // 实现 1 参数 Invoke
    STDMETHOD(Invoke)(
        typename std::tuple_element_t<0, typename InvokeTraits<TInterface>::ArgsTuple> arg1) override
    {
...
public:
    ...
    STDMETHOD(Invoke)(
        ...
        typename std::tuple_element_t<1, typename InvokeTraits<TInterface>::ArgsTuple> arg2) override
    {
...
public:
    ...
    STDMETHOD(Invoke)(
        ...
        typename std::tuple_element_t<2, typename InvokeTraits<TInterface>::ArgsTuple> arg3) override
    {
...
public:
    ...
    STDMETHOD(Invoke)(
        ...
        typename std::tuple_element_t<3, typename InvokeTraits<TInterface>::ArgsTuple> arg4) override
    {
...
public:
    ...
    STDMETHOD(Invoke)(
        ...
        typename std::tuple_element_t<4, typename InvokeTraits<TInterface>::ArgsTuple> arg5) override
    {
...
public:
    ...
    STDMETHOD(Invoke)(
        ...
        typename std::tuple_element_t<5, typename InvokeTraits<TInterface>::ArgsTuple> arg6) override
    {
...
ComPtr<TInterface> ComCallback(TCallback &&callback)
{
    ...
    static_assert(
        InvokeTraits<TInterface>::HasInvoke,
    ...
    static_assert(
        InvokeTraits<TInterface>::ArgCount <= 6, "The Invoke method supports up to 6 parameters");
...
ComPtr<TInterface> ComCallback(T *obj, HRESULT (STDMETHODCALLTYPE T::*method)(Args...))
{
    return ComCallback<TInterface, IID_TInterface>(
        [obj, method](Args... args) -> HRESULT { return (obj->*method)(args...); });
}
