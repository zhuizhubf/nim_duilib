...
namespace ui {
class DUILIB_API WebView2EnvironmentOptions : public ICoreWebView2EnvironmentOptions,
...
public:
    ...
    IFACEMETHODIMP GetCustomSchemeRegistrations(
        UINT32 *count, ICoreWebView2CustomSchemeRegistration ***schemeRegistrations) override;
    IFACEMETHODIMP SetCustomSchemeRegistrations(
        UINT32 count, ICoreWebView2CustomSchemeRegistration **schemeRegistrations) override;
