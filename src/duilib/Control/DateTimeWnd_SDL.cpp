...
bool DateTimeWnd::Init(DateTime *pOwner)
{
    ...
    for (RichEdit *pRichEdit : m_editList) {
        if (pRichEdit != nullptr) {
            ...
            pRichEdit->SetAttributeById(ui::attr::control::kHeight, _T("100%"));
            pRichEdit->SetAttributeById(ui::attr::control::kWidth, _T("auto"));
            pRichEdit->SetAttributeById(ui::attr::control::kTextPadding, _T("2,1,2,1"));
            pRichEdit->SetAttributeById(ui::attr::control::kHideSelection, _T("true"));
    ...
    pEmpty->SetAttributeById(ui::attr::control::kWidth, _T("100%"));
    pEmpty->SetAttributeById(ui::attr::control::kHeight, _T("100%"));
...
RichEdit *DateTimeWnd::CreateEditYear() const
{
    ...
    pRichEdit->SetAttributeById(ui::attr::control::kLimitText, _T("4"));
    pRichEdit->SetAttributeById(ui::attr::control::kNumberFormat, _T("%04I64d"));
...
{
    RichEdit *pRichEdit = new RichEdit(m_pOwner->GetWindow());
    pRichEdit->SetAttributeById(ui::attr::control::kLimitText, _T("2"));
    pRichEdit->SetAttributeById(ui::attr::control::kNumberFormat, _T("%02I64d"));
...
Control *DateTimeWnd::CreateLabel(const DString &text) const
{
    ...
    pLabel->SetText(text);
    pLabel->SetAttributeById(ui::attr::control::kTextAlign, _T("vcenter,hcenter"));
    pLabel->SetAttributeById(ui::attr::control::kWidth, _T("auto"));
    pLabel->SetAttributeById(ui::attr::control::kMinWidth, _T("4"));
    pLabel->SetAttributeById(ui::attr::control::kHeight, _T("100%"));
