...
DString ColorPickerStandard::GetType() const
{
    return DUI_CTR_COLOR_PICKER_STANDARD;
}
...
void ColorPickerStandard::DrawColorMap(IRender *pRender, const UiRect &rect)
{
    ...
    const int32_t radius = static_cast<int32_t>(
        rectSize / 13 / 2 / std::cos(30 / 57.2957795f)); //半径
    m_radius = radius;
...
bool ColorPickerStandard::DrawRegularHexagon(
    IRender *pRender,
...
bool ColorPickerStandard::MouseMove(const EventArgs &msg)
{
    ...
    if (GetRect().ContainsPt(msg.ptMouse)) {
        ...
        if (GetColorInfo(msg.ptMouse, color, colorNameId)) {
            ...
            colorStringTip += _T("(");
            colorStringTip += StringUtil::Printf(
                _T("#%02X%02X%02X%02X"), color.GetA(), color.GetR(), color.GetG(), color.GetB());
            colorStringTip += _T(")");
...
bool ColorPickerStandard::GetColorInfo(
    const UiPoint &ptMouse, UiColor &ptColor, DString &colorNameId) const
{
    struct ColorPt
    {
        //颜色值
        ...
        //比较函数，距离最近的排在前面
        bool operator<(const ColorPt &r) const { return distance < r.distance; }
    };

    std::vector<ColorPt> maybeColors;
    for (const ColorInfo &colorInfo : m_colorMap) {
        float distance
            = GetPointsDistance(colorInfo.centerPt, UiPointF((float) ptMouse.x, (float) ptMouse.y));
...
void ColorPickerStandard::InitColorMap()
{
    m_colorMap = {
        ...
        {UiColor(0xFF333399),
         _T("STRID_PUBLIC_COLORPICKER_TIP3_DARK_LAVENDER_1"),
         UiPointF()}, // 深薰衣草紫1
        ...
        {UiColor(0xFF3333CC),
         _T("STRID_PUBLIC_COLORPICKER_TIP3_DARK_LAVENDER_2"),
         UiPointF()}, // 深薰衣草紫2
        {UiColor(0xFF666699), _T("STRID_PUBLIC_COLORPICKER_TIP3_SLATE_GRAY"), UiPointF()}, // 石板灰
        {UiColor(0xFF339966),
         _T("STRID_PUBLIC_COLORPICKER_TIP3_MINT_GREEN_1"),
         UiPointF()}, // 薄荷绿1
        ...
        {UiColor(0xFF6600CC),
         _T("STRID_PUBLIC_COLORPICKER_TIP3_DARK_VIOLET_1"),
         UiPointF()}, // 深紫罗兰1
        {UiColor(0xFF339933), _T("STRID_PUBLIC_COLORPICKER_TIP3_MID_GREEN_1"), UiPointF()}, // 中绿1
        {UiColor(0xFF00CC66),
         _T("STRID_PUBLIC_COLORPICKER_TIP3_MINT_GREEN_2"),
         UiPointF()}, // 薄荷绿2
        ...
        {UiColor(0xFF9999FF),
         _T("STRID_PUBLIC_COLORPICKER_TIP3_LAVENDER_1"),
         UiPointF()},                                                                   // 薰衣草紫1
        ...
        {UiColor(0xFF00CC00),
         _T("STRID_PUBLIC_COLORPICKER_TIP3_BRIGHT_GREEN_1"),
         UiPointF()},                                                                      // 亮绿1
        ...
        {UiColor(0xFFCCCCFF),
         _T("STRID_PUBLIC_COLORPICKER_TIP3_PALE_LAVENDER"),
         UiPointF()}, // 淡薰衣草紫
        ...
        {UiColor(0xFF33CC33),
         _T("STRID_PUBLIC_COLORPICKER_TIP3_BRIGHT_GREEN_2"),
         UiPointF()}, // 亮绿2
        ...
        {UiColor(0xFF336600),
         _T("STRID_PUBLIC_COLORPICKER_TIP3_OLIVE_GREEN_1"),
         UiPointF()}, // 橄榄绿1
        ...
        {UiColor(0xFF669900),
         _T("STRID_PUBLIC_COLORPICKER_TIP3_OLIVE_GREEN_2"),
         UiPointF()}, // 橄榄绿2
        ...
        {UiColor(0xFF99CC00),
         _T("STRID_PUBLIC_COLORPICKER_TIP3_YELLOW_GREEN_1"),
         UiPointF()}, // 黄绿1
        ...
        {UiColor(0xFF660033),
         _T("STRID_PUBLIC_COLORPICKER_TIP3_DARK_RED_PURPLE"),
         UiPointF()},                                                                   // 深红紫
        {UiColor(0xFF996633), _T("STRID_PUBLIC_COLORPICKER_TIP3_BROWN_1"), UiPointF()}, // 棕色1
        {UiColor(0xFFCC9900),
         _T("STRID_PUBLIC_COLORPICKER_TIP3_GOLDEN_YELLOW"),
         UiPointF()},                                                                    // 金黄色
