...
public:
     ...
     */
    virtual void OnWindowCreateMsg(const ui::NativeMsg &nativeMsg, bool &bHandled)
    {
        (void) nativeMsg;
        (void) bHandled;
    }
     ...
     * @return 返回消息的处理结果，如果应用程序处理此消息，应返回零
     */
    virtual LRESULT OnWindowCloseMsg(uint32_t wParam, const ui::NativeMsg &nativeMsg, bool &bHandled)
    {
        (void) wParam;
        (void) nativeMsg;
        (void) bHandled;
    ...
    * @return 返回消息的处理结果，如果应用程序处理此消息，应返回零
    */
    virtual LRESULT OnWindowPosChangedMsg(const ui::NativeMsg &nativeMsg, bool &bHandled)
    {
        (void) nativeMsg;
        (void) bHandled;
        return 0;
    ...
    virtual LRESULT OnMoveMsg(
        const ui::UiPoint &ptTopLeft, const ui::NativeMsg &nativeMsg, bool &bHandled)
    {
        (void) ptTopLeft;
        (void) nativeMsg;
        (void) bHandled;
     ...
     * @return 返回消息的处理结果，如果应用程序处理此消息，应返回零
     */
    virtual LRESULT OnShowWindowMsg(bool bShow, const ui::NativeMsg &nativeMsg, bool &bHandled)
    {
        (void) bShow;
        (void) nativeMsg;
        (void) bHandled;
    ...
    virtual LRESULT OnSetFocusMsg(
        ui::WindowBase *pLostFocusWindow, const ui::NativeMsg &nativeMsg, bool &bHandled)
    {
        (void) pLostFocusWindow;
        (void) nativeMsg;
        (void) bHandled;
        return 0;
    }
    ...
    virtual LRESULT OnKillFocusMsg(
        ui::WindowBase *pSetFocusWindow, const ui::NativeMsg &nativeMsg, bool &bHandled)
    {
        (void) pSetFocusWindow;
        (void) nativeMsg;
        (void) bHandled;
        return 0;
    }
     ...
     */
    virtual LRESULT OnSetCursorMsg(const ui::NativeMsg &nativeMsg, bool &bHandled)
    {
        (void) nativeMsg;
        (void) bHandled;
        return 0;
     ...
     * @return 返回消息的处理结果，如果应用程序处理此消息，应返回零
     */
    virtual LRESULT OnMouseLeaveMsg(const ui::NativeMsg &nativeMsg, bool &bHandled)
    {
        (void) nativeMsg;
        (void) bHandled;
        return 0;
     ...
     * @return 返回消息的处理结果，如果应用程序处理此消息，应返回零
     */
    virtual LRESULT OnCaptureChangedMsg(const ui::NativeMsg &nativeMsg, bool &bHandled)
    {
        (void) nativeMsg;
        (void) bHandled;
        return 0;
    ...
    */
    virtual void OnWindowDisplayScaleChanged(uint32_t nOldScaleFactor, uint32_t nNewScaleFactor)
    {
        (void) nOldScaleFactor;
        (void) nNewScaleFactor;
    }
};
