...
private:
    ...
    */
    struct RegularColor
    {
        ...
        {
            //按照颜色的灰度值排序
            double v1 = colorValue.GetR() * 0.299 + colorValue.GetG() * 0.587
                        + colorValue.GetB() * 0.114;
            double v2 = r.colorValue.GetR() * 0.299 + r.colorValue.GetG() * 0.587
                        + r.colorValue.GetB() * 0.114;
            return v1 < v2;
        }
    };
...
DString ColorPickerRegular::GetType() const
{
    return DUI_CTR_COLOR_PICKER_REGULAR;
}
...
bool ColorPickerRegularProvider::FillElement(ui::Control *pControl, size_t nElementIndex)
{
    if ((pControl != nullptr) && (nElementIndex < m_colors.size())) {
        ...
        DString colorString = StringUtil::Printf(
            _T("#%02X%02X%02X%02X"),
...
void ColorPickerRegularProvider::GetDefaultColors(std::vector<std::pair<DString, int32_t>> &uiColors)
{
    ...
    uiColors = {
        ...
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_AntiqueWhite"),
         UiColors::AntiqueWhite},                                   // AntiqueWhite,古董白
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_Aqua"), UiColors::Aqua}, // Aqua,浅绿色
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_Aquamarine"),
         UiColors::Aquamarine},                                         // Aquamarine,海蓝宝石色
        ...
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_BlanchedAlmond"),
         UiColors::BlanchedAlmond},                                 // BlanchedAlmond,白杏色
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_Blue"), UiColors::Blue}, // Blue,蓝色
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_BlueViolet"),
         UiColors::BlueViolet},                                       // BlueViolet,蓝紫罗兰色
        ...
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_CornflowerBlue"),
         UiColors::CornflowerBlue},                                         // CornflowerBlue,菊兰色
        ...
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_DarkGoldenrod"),
         UiColors::DarkGoldenrod}, // DarkGoldenrod,深金黄黄
        ...
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_DarkKhaki"),
         UiColors::DarkKhaki}, // DarkKhaki,暗卡其色，深黄褐色
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_DarkMagenta"),
         UiColors::DarkMagenta}, // DarkMagenta,深品红色，暗洋红
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_DarkOliveGreen"),
         UiColors::DarkOliveGreen}, // DarkOliveGreen,暗橄榄绿
        ...
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_DarkSeaGreen"),
         UiColors::DarkSeaGreen}, // DarkSeaGreen,深海蓝色
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_DarkSlateBlue"),
         UiColors::DarkSlateBlue}, // DarkSlateBlue,深灰蓝色
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_DarkSlateGray"),
         UiColors::DarkSlateGray}, // DarkSlateGray,暗绿色
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_DarkTurquoise"),
         UiColors::DarkTurquoise}, // DarkTurquoise,暗宝石绿色
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_DarkViolet"),
         UiColors::DarkViolet},                                             // DarkViolet,暗紫罗兰色
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_DeepPink"), UiColors::DeepPink}, // DeepPink,深粉红色
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_DeepSkyBlue"),
         UiColors::DeepSkyBlue},                                          // DeepSkyBlue,深天蓝色
        ...
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_FloralWhite"),
         UiColors::FloralWhite}, // FloralWhite,花白色
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_ForestGreen"),
         UiColors::ForestGreen},                                              // ForestGreen,森林绿
        ...
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_GhostWhite"),
         UiColors::GhostWhite},                                               // GhostWhite,幽灵白色
        ...
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_GreenYellow"),
         UiColors::GreenYellow},                                              // GreenYellow,黄绿色
        ...
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_Lavender"),
         UiColors::Lavender}, // Lavender,薰衣草色，淡紫色
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_LavenderBlush"),
         UiColors::LavenderBlush}, // LavenderBlush,淡紫红色
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_LawnGreen"), UiColors::LawnGreen}, // LawnGreen,草绿色
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_LemonChiffon"),
         UiColors::LemonChiffon}, // LemonChiffon,柠檬绸色
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_LightBlue"), UiColors::LightBlue}, // LightBlue,淡蓝色
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_LightCoral"),
         UiColors::LightCoral},                                               // LightCoral,淡珊瑚色
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_LightCyan"), UiColors::LightCyan}, // LightCyan,淡青色
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_LightGoldenrodYellow"),
         UiColors::LightGoldenrodYellow}, // LightGoldenrodYellow,亮菊黄
        ...
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_LightSalmon"),
         UiColors::LightSalmon}, // LightSalmon,亮肉色
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_LightSeaGreen"),
         UiColors::LightSeaGreen}, // LightSeaGreen,浅海蓝色
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_LightSkyBlue"),
         UiColors::LightSkyBlue}, // LightSkyBlue,亮天蓝色
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_LightSlateGray"),
         UiColors::LightSlateGray}, // LightSlateGray,亮蓝灰
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_LightSteelBlue"),
         UiColors::LightSteelBlue}, // LightSteelBlue,亮钢蓝色
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_LightYellow"),
         UiColors::LightYellow},                                              // LightYellow,浅黄色
        ...
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_MediumAquamarine"),
         UiColors::MediumAquamarine}, // MediumAquamarine,中碧绿色
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_MediumBlue"), UiColors::MediumBlue}, // MediumBlue,中蓝色
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_MediumOrchid"),
         UiColors::MediumOrchid}, // MediumOrchid,中兰花紫
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_MediumPurple"),
         UiColors::MediumPurple}, // MediumPurple,中紫色
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_MediumSeaGreen"),
         UiColors::MediumSeaGreen}, // MediumSeaGreen,中海洋绿
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_MediumSlateBlue"),
         UiColors::MediumSlateBlue}, // MediumSlateBlue,中板岩蓝
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_MediumSpringGreen"),
         UiColors::MediumSpringGreen}, // MediumSpringGreen,中春绿色
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_MediumTurquoise"),
         UiColors::MediumTurquoise}, // MediumTurquoise,中绿宝石色
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_MediumVioletRed"),
         UiColors::MediumVioletRed}, // MediumVioletRed,中紫罗兰色
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_MidnightBlue"),
         UiColors::MidnightBlue},                                             // MidnightBlue,深夜蓝
        ...
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_NavajoWhite"),
         UiColors::NavajoWhite},                                              // NavajoWhite,纳瓦白
        ...
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_PaleGoldenrod"),
         UiColors::PaleGoldenrod}, // PaleGoldenrod,淡黄色
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_PaleGreen"), UiColors::PaleGreen}, // PaleGreen,淡绿色
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_PaleTurquoise"),
         UiColors::PaleTurquoise}, // PaleTurquoise,苍绿色
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_PaleVioletRed"),
         UiColors::PaleVioletRed}, // PaleVioletRed,浅紫罗兰红
        ...
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_SaddleBrown"),
         UiColors::SaddleBrown},                                        // SaddleBrown,重褐色
        ...
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_SpringGreen"),
         UiColors::SpringGreen},                                              // SpringGreen,春绿色
        ...
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_Transparent"),
         UiColors::Transparent},                                              // Transparent,透明的
        ...
        {_T("STRID_PUBLIC_COLORPICKER_TIP1_YellowGreen"),
         UiColors::YellowGreen} // YellowGreen,黄绿色
    };
}
