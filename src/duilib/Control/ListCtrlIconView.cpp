...
void ListCtrlIconView::SetAttributeById(ui::attr::control::Id id, const DString &strValue2)
{
...
bool ListCtrlIconView::FillDataItem(
    Control *pControl,
...
int32_t ListCtrlIconView::GetMaxDataItemWidth(
