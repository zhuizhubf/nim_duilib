...
DString ColorPickerStandardGray::GetType() const
{
    return DUI_CTR_COLOR_PICKER_STANDARD_GRAY;
}
...
void ColorPickerStandardGray::DrawColorMap(IRender *pRender, const UiRect &rect)
{
    ...
    if (!selectBrushColor.IsEmpty()) {
        DrawRegularHexagon(
            pRender, selectCenterPt, selectedRadius, penColor, penWidth, selectBrushColor);
    }
}

bool ColorPickerStandardGray::DrawRegularHexagon(
    IRender *pRender,
...
bool ColorPickerStandardGray::GetColorInfo(
...
void ColorPickerStandardGray::InitColorMap()
{
    m_colorMap = {
        ...
        {UiColor(0xFFDDDDDD),
         UiPointF(),
         0,
         _T("STRID_PUBLIC_COLORPICKER_TIP4_LIGHT_GRAY_1")},                               // 浅灰1
        ...
        {UiColor(0xFF1C1C1C),
         UiPointF(),
         0,
         _T("STRID_PUBLIC_COLORPICKER_TIP4_ALMOST_BLACK_1")}, // 近黑1
        {UiColor(0xFF080808),
         UiPointF(),
         0,
         _T("STRID_PUBLIC_COLORPICKER_TIP4_ALMOST_BLACK_2")}, // 近黑2
        {UiColor(0xFFEAEAEA),
         UiPointF(),
         0,
         _T("STRID_PUBLIC_COLORPICKER_TIP4_LIGHT_GRAY_2")},                               // 浅灰2
        ...
        {UiColor(0xFF111111),
         UiPointF(),
         0,
         _T("STRID_PUBLIC_COLORPICKER_TIP4_ALMOST_BLACK_3")},                           // 近黑3
