...
private:
    ...
    */
    void AdjustMergedCellPositions(
    ...
    * @param [out] ctrlCellRects 列表控件的位置和大小
    */
    void ArrangeControlsInMergedCells(
        const std::vector<Control *> &controls,
