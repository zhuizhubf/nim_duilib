...
template<typename T>
inline DString ControlResizableT<T>::GetType() const
{
    return DUI_CTR_CONTROL_RESIZABLE;
}

template<>
inline DString ControlResizableT<Box>::GetType() const
{
    return DUI_CTR_BOX_RESIZABLE;
}

template<>
inline DString ControlResizableT<HBox>::GetType() const
{
    return DUI_CTR_HBOX_RESIZABLE;
}

template<>
inline DString ControlResizableT<VBox>::GetType() const
{
    return DUI_CTR_VBOX_RESIZABLE;
}
...
template<typename T>
typename ControlResizableT<T>::SizeType ControlResizableT<T>::GetCurrentSizeType(
    const UiPoint &ptMouse) const
{
    UiPoint pt(ptMouse);
    pt.Offset(this->GetScrollOffsetInScrollBox());
