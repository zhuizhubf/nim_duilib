...
public:
    ...
    */
     ...
     */
    FilePath FindExistsResFullPath(
        const FilePath &windowResPath,
...
private:
    ...
    */
    ...
    struct ThemeChangedEventData
    {
        ...
        //比较操作符
        bool operator==(const ThemeChangedEventData &r) const
        {
            return m_callbackId == r.m_callbackId;
        }
    };
