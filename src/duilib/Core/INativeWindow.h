...
public:
    ...
    /** 窗口消息的派发函数
    */
    virtual LRESULT OnNativeWindowMessage(UINT uMsg, WPARAM wParam, LPARAM lParam, bool &bHandled)
        = 0;
    ...
    */
    virtual void OnNativeProcessDisplayScaleChangedMsg(
        float fNewDisplayScale, float fNewPixelDensity) = 0;
    ...
    */
    virtual LRESULT OnNativeMoveMsg(
        const UiPoint &ptTopLeft, const NativeMsg &nativeMsg, bool &bHandled) = 0;
    ...
    * @return 返回消息的处理结果，如果应用程序处理此消息，应返回零
    */
    virtual LRESULT OnNativeShowWindowMsg(bool bShow, const NativeMsg &nativeMsg, bool &bHandled)
        = 0;
    ...
    */
    virtual LRESULT OnNativePaintMsg(
        const UiRect &rcPaint, const NativeMsg &nativeMsg, bool &bHandled) = 0;
    ...
    */
    virtual LRESULT OnNativeSetFocusMsg(
        INativeWindow *pLostFocusWindow, const NativeMsg &nativeMsg, bool &bHandled) = 0;
    ...
    */
    virtual LRESULT OnNativeKillFocusMsg(
        INativeWindow *pSetFocusWindow, const NativeMsg &nativeMsg, bool &bHandled) = 0;
    ...
    */
    virtual LRESULT OnNativeContextMenuMsg(
        const UiPoint &pt, const NativeMsg &nativeMsg, bool &bHandled) = 0;
    ...
    */
    virtual LRESULT OnNativeWindowCloseMsg(
        uint32_t wParam, const NativeMsg &nativeMsg, bool &bHandled) = 0;
