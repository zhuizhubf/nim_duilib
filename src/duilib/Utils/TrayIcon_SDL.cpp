...
private:
    ...
    */
    TraySurfaceData LoadSDLSurfaceFromFileData(
...
TrayIconImpl::TraySurfaceData TrayIconImpl::LoadSDLSurfaceFromFile(
    const Window *pWindow, const DString &iconFilePath)
{
...
TrayIconImpl::TraySurfaceData TrayIconImpl::LoadSDLSurfaceFromFileData(
    const std::vector<uint8_t> &fileData, const DString &iconFilePath)
{
...
bool TrayIconImpl::Show()
{
    ...
    if (m_sdlTray == nullptr) {
        ...
        SDL_SetPointerProperty(
            ...
            (void *) &TrayIconImpl::OnSDLTrayLeftClickCallback);
        SDL_SetPointerProperty(
            props,
            SDL_PROP_TRAY_CREATE_RIGHTCLICK_CALLBACK_POINTER,
            (void *) &TrayIconImpl::OnSDLTrayRightClickCallback);
        SDL_SetPointerProperty(
            props,
