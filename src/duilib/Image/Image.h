...
public:
    ...
    */
    AnimationFramePtr GetCurrentFrame(
...
public:
    ...
    */
    std::shared_ptr<IBitmap> GetCurrentBitmap(
        bool bImageStretch,
        const UiRect &rcDest,
        UiRect &rcSource,
...
public:
    ...
    */
    ...
    bool StartImageAnimation(
        AnimationImagePos nStartFrame = AnimationImagePos::kFrameFirst, int32_t nPlayCount = 0);
    ...
    void StopImageAnimation(
        AnimationImagePos nStopFrame = AnimationImagePos::kFrameCurrent, bool bTriggerEvent = false);
    /** @} */
...
private:
    ...
    * @param [out] bDecodeError 返回true代表遇到图片解码错误
    */
    std::shared_ptr<IBitmap> GetBitmapData(
