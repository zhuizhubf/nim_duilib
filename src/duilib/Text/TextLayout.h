...
public:
    ...
    */
    ...
    /** 绘制普通字符串
    */
    static void DrawString(ITextShaper& textShaper,
                           IRender* pRender,
                           const DString& strText,
    ...
    /** 计算富文本的绘制区域
    */
    static void MeasureRichText(ITextShaper& textShaper,
    ...
    /** 计算富文本并输出行/字符信息
    */
    static void MeasureRichText2(ITextShaper& textShaper,
                                 const UiRect& textRect,
                                 const UiSize& szScrollOffset,
                                 const std::vector<RichTextData>& richTextData,
    ...
    /** 绘制富文本
    */
    static void DrawRichText(ITextShaper& textShaper,
                             IRender* pRender,
                             const UiRect& textRect,
                             const UiSize& szScrollOffset,
                             const std::vector<RichTextData>& richTextData,
