...
#ifndef UI_RENDER_SKIA_SK_UTF_H_
#define UI_RENDER_SKIA_SK_UTF_H_

#include <cstddef>
#include <cstdint>

//该文件原始文件的出处：skia/src/base/SkUTF.h
...
*/
SkUnichar NextUTF8WithReplacement(const char **ptr, const char *end);
...
#endif // UI_RENDER_SKIA_SK_UTF_H_
