...
#include "render-skia/FastVector.h"
#include "render-skia/SkiaTextData.h"
...
struct MeasureTextTempData
{
    ...
    FastVector<SkScalar>
        glyphWidths; //每个SkGlyphID字符的所占的宽度，该宽度与字体名称和字体大小、是否斜体等属性均相关，容器大小与glyphIDs容器相同
};
...
{
    FastVector<SkGlyphID>
        glyphIDs; //文本对应的SkGlyphID列表（只可用于统计字符数量，不可用于绘制，因为对应的字体可能不同）
...
public:
    ...
    * @return 返回对应的回退字体接口
    */
    static const SkFont *CreateFallbackFont(
...
public:
    ...
    */
    static SkScalar MeasureTextChar(
        const SkFont &font,
        DUTF32Char ch,
        SkRect *bounds,
        const SkPaint *paint,
...
public:
    /** 绘制文本，支持字体回退
    */
    static SkScalar DrawSimpleText(
        SkCanvas *skCanvas,
        DUTF32Char ch,
        SkScalar x,
        SkScalar y,
...
private:
    ...
    */
    static UTF32String GetDrawStringUTF32(
