#ifndef UI_IMAGE_IMAGE_DECODER_WEBP_H_
#define UI_IMAGE_IMAGE_DECODER_WEBP_H_
...
/** WEBP格式的图片解码器接口
*/
class UILIB_API ImageDecoder_WEBP: public IImageDecoder
{
public:
    ImageDecoder_WEBP();
    virtual ~ImageDecoder_WEBP() override;
...
#endif //UI_IMAGE_IMAGE_DECODER_WEBP_H_
