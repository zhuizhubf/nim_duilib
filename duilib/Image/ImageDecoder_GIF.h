#ifndef UI_IMAGE_IMAGE_DECODER_GIF_H_
#define UI_IMAGE_IMAGE_DECODER_GIF_H_
...
/** GIF格式的图片解码器接口
*/
class DUILIB_API ImageDecoder_GIF: public IImageDecoder
{
public:
    ImageDecoder_GIF();
    virtual ~ImageDecoder_GIF() override;
