#ifndef UI_IMAGE_IMAGE_DECODER_LOTTIE_H_
#define UI_IMAGE_IMAGE_DECODER_LOTTIE_H_
...
/** LOTTIE格式的图片解码器接口
*/
class DUILIB_API ImageDecoder_LOTTIE: public IImageDecoder
{
public:
    ImageDecoder_LOTTIE();
    virtual ~ImageDecoder_LOTTIE() override;
...
#endif //UI_IMAGE_IMAGE_DECODER_GIF_H_
