#ifndef UI_IMAGE_IMAGE_DECODER_SVG_H_
#define UI_IMAGE_IMAGE_DECODER_SVG_H_
...
/** SVG格式的图片解码器接口
*/
class DUILIB_API ImageDecoder_SVG: public IImageDecoder
{
public:
    ImageDecoder_SVG();
    virtual ~ImageDecoder_SVG() override;
...
#endif //UI_IMAGE_IMAGE_DECODER_SVG_H_
