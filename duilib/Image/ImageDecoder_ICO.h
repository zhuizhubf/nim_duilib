#ifndef UI_IMAGE_IMAGE_DECODER_ICO_H_
#define UI_IMAGE_IMAGE_DECODER_ICO_H_
...
/** ICO/CUR格式的图片解码器接口
*/
class DUILIB_API ImageDecoder_ICO: public IImageDecoder
{
public:
    ImageDecoder_ICO();
    virtual ~ImageDecoder_ICO() override;
...
#endif //UI_IMAGE_IMAGE_DECODER_ICO_H_
