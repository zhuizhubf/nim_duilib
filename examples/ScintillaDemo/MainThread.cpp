...
bool MainThread::OnInit()
{
    ...
    //注册 Scintilla 控件工厂（必须在加载包含 ScintillaControl 的 XML 之前）
    duilib::ext::scintilla::ScintillaManager::Instance().Initialize();

    //创建主窗口
    MainForm *window = new MainForm();
    window->CreateWnd(nullptr, ui::WindowCreateParam(_T("ScintillaDemo"), true));
...
{
    duilib::ext::scintilla::ScintillaManager::Instance().UnInitialize();
